...
The AI world, as we know it, will change soon. Nvidia, OpenAI, Meta, Google are in trouble

- They've paid too mch for technology which, if want to wait 3 months, you can get from free from China.
...
- The cloud-based subscrioption model will collpase and we discover ways to scale down LLMs to local machines.
- The $1.2 tillion dollar data center debt will destroy them, especially since they those data centers age so quickly.
- Dreams of replacing humans with automation will become nightmare maintainance and monitoring scaneios (see "AI Slop:" [^baltes]
...
So there is an opprtunity to reshape what we mean by AI. What could we do with that?
